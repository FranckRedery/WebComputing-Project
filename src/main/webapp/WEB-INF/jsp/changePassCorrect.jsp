			  ...
			  <div class="card bg-dark text-white" style="border-radius: 1rem;">
				<div class="card-body p-3 text-center">
				  <div class="mb-md-10 mt-md-2 pb-4">
					  <h2 style="color: cornsilk;" class="fw-bold mb-2 text-uppercase">Password changed successfully</h2>
					<img src="/images/index/logo.png" alt="">
					<div class="form-outline form-white mb-3">
					<img src="/images/account/greenCheck.gif" width="100" height="80" alt=""> 
					<p>Congratulations ${username}, your password have been changed</p>
					</div>
					<a href="account.html">
