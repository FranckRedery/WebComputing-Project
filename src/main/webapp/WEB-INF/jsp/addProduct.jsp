<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <h2 style="margin-top:2%;" id="pageTitle">Add product</h2>

            <form class="needs-validation" method="post" action="/addNewProduct" enctype="multipart/form-data"
                id="addProd" novalidate>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="productCategory" name="productCategory"
                        placeholder="Product category" onchange="caricaOpzioni()" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="10" id="description" name="productDescription"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-label" min="1" max="10000" step=".01" name="productPrice"
                        oninput="validity.valid||(value='');" id="amount" required>
