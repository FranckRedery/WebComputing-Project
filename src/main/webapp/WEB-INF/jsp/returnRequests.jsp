                        ...
                        <c:forEach items="${returns}" var="item">
                            <tr>
                                <td class="user-cell">
                                    <div class="align-items-center text-center " id="user">
                                        ...
                                        <span class="font-weight-bold;" id="username"
                                            style="font-size: small;">${item.user.username}</span>
                                        <br>
                                        <span class="info" style="font-size: small;">Email : </span>
                                        <span class="font-weight-bold;" id="email"
                                            style="font-size: small;">${item.user.email}</span>
                                    </div>
                                </td>
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center "><img
                                        ...
                                        <div class="product-info">
                                            ...
                                            <span class="product-id" id="prodId"
                                                style="font-size: small;">${item.product.id}</span>
                                            <br>
                                ...
                                <td class="reason-cell">
                                    <c:if test="${item.description != ''}">
                                        <c:if test="${item.reason != 'Other, specify in the description'}">
                                            <textarea class="form-control" id="textArea" rows="9" cols="9"
                                ...
                                <td class="refund-cell">
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center" id="amount-cell">
                                        Money to return<input type="number" value="0" class="text-center" step=".01"
                                            min="0" max="${item.product.price * item.quantity}"
                                            oninput="validity.valid||(value='');" id="amount"></div>
                                </td>
