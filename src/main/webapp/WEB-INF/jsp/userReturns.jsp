                ...
                <div id="top-header">
                    <div class="container">
                        <ul class="header-links pull-left">
                            ...
                            <li><a href="#"><i class="fa fa-map-marker"></i>Ponte Pietro Bucci, 87036 Quattromiglia
                                    CS</a></li>
                                ...
                                <c:if test="${isAdmin == 't'}">
                                    <a href="adminPage" style="text-decoration: none;">
                                        <button class="btnAdmin">
                                            <span>Admin View <img src="images/index/adminBtn.gif" width="20"
                                                    height="20"></span>
                                        </button>
                                    </a>
                                </c:if>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="header-logo">
                                    <a href="/" class="logo"> <img id="logo" src="images/index/logo.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <!-- /LOGO -->
                            ...
                            <div class="col-md-3">
                                <div class="header-ctn">
                                        ...
                                        <c:if test="${loggato == 'si'}">
                                            <c:if test="${loggatoGoogle == 'si'}">
                                                <a href="account.html" style="text-decoration: none; display: flex;">
                                                    <img class="profilePic" src='${image}' style="border-radius: 50%;"
                                                        width="29" height="29" alt="Avatar">
                                                    ${username}
                                                </a>
                                            </c:if>
                                            <c:if test="${loggatoGoogle == 'no' || loggatoGoogle == null }">
                                                <div style="display: flex">
                                                    ...
                                                    <p id="nameP" class="overflow-ellipsis">${username}</p>
                                                </div>
                                            </c:if>
                                        </c:if>
                                        <c:if test="${loggato == 'no' || loggato == null }">
                                    ...
                                    <div style="padding-right: 10%; padding-left: 0%;">
                                        <a href="wishList.html" style="text-decoration: none;"> <i class="fa fa-heart"
                                                id="heart"></i>
                            ...
                            <tr>
                                <td class="product-cell">
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center "><img
                                            src="${item.product.image}" class="img-fluid d-block mx-auto">
                                        <div class="product-info">
                                            <span class="info" style="font-size: small; display: none">Product ID :
                                            </span>
                                            <span class="product-id" id="prodId"
                                                style="font-size: small; display: none">${item.product.id}</span>
                                            ...
                                            <span class="product-quantity" id="qty"
                                                style="font-size: medium;">${item.quantity}</span>
                                            <br>
                                ...
                                <td class="reason-cell">
                                    <c:if test="${item.description != ''}">
                                        <c:if test="${item.reason != 'Other, specify in the description'}">
                                            <textarea class="form-control" id="textArea" rows="10" cols="9"
