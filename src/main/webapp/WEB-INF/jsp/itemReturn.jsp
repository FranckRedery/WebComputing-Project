            ...
            <form class="needs-validation" novalidate>
                <div class="row" id="riga">
                    <div class="col-md-7">
                        ...
                        <div class="product-info">
                            ...
                            <span class="product-id" id="prodId"
                                style="font-size: small; display: none;">${returnProd.id}</span>
                            <br>
                            ...
                            <span class="product-price" id="prodPrice" style="font-size: medium;">$${(returnProd.price *
                                qty)}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <br>
                        <label for="description" class="description" id="description">Additional description
                            (optional)</label>
                        <textarea class="form-control" rows="5" name="text" id="textArea"
